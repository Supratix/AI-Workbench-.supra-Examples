# SME Onboarding Micro-SOP Factory
...
- **Module:** `sme_onboarding_micro_sop_factory`
- **Vendor:** SupraTix
- **Schema version:** `1`
...
Turn onboarding context into short, usable SOPs and role-ready checklists.
...
```json
{
  ...
  "use_case": "sme_onboarding_micro_sop_factory",
  "focus": "onboarding pain points, role tasks, handover knowledge, SOP structure, acceptance checks, and owners",
  "intake": "Business context: We need a reliable decision support flow for SME Onboarding Micro-SOP Factory.\nCurrent situation: Inputs are incomplete, owners need an answer this week, and leadership wants visible assumptions.\nKnown constraint: Do not invent facts; mark evidence gaps and human-review items.",
  "guardrails": [
    "Do not invent facts.",
...
| 2 | `signal_map`       | Signal map       | `ai_tool`  | `sme_onboarding_micro_sop_factory_signals`  | `business_context`                                    | `manual_review` | yes    | `summary`<br>`signals`<br>`constraints`<br>`assumptions`<br>`risks`<br>`evidence_gaps` |
| 3 | `decision_plan`    | Decision plan    | `ai_tool`  | `sme_onboarding_micro_sop_factory_decision` | `business_context`<br>`signal_map`                    | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`metrics`<br>`risks`<br>`evidence_gaps`        |
| 4 | `execution_brief`  | Execution brief  | `shortcut` | `sme_onboarding_micro_sop_factory`          | `business_context`<br>`signal_map`<br>`decision_plan` | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`risks`<br>`evidence_gaps`                     |
