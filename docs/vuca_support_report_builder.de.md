...
- **Quellpaket:** [`../vuca_support_report_builder.supra`](../vuca_support_report_builder.supra)
- **Workbench-Titel:** VUCA Support Report Builder Desk
- **Paket-Key:** `vuca_support_report_builder`
- **Modul:** `vuca_support_report_builder`
- **Anbieter:** SupraTix
- **Schema-Version:** `1`
