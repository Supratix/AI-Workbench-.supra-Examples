...
- **Source package:** [`../sme_hiring_scorecard_kit.supra`](../sme_hiring_scorecard_kit.supra)
- **Workbench title:** SME Hiring Scorecard Kit Desk
- **Package key:** `sme_hiring_scorecard_kit`
- **Vendor:** SupraTix
- **Schema version:** `1`
- **Columns:** 4
- **Workflows:** 1
...
Create a role scorecard with success outcomes, interview signals, decision rubric, evidence prompts, and hiring risk notes for SME teams.
...
| 2 | `signal_map`       | Signal map       | `ai_tool`  | `sme_hiring_scorecard_kit_signals`  | yes    | `summary`<br>`signals`<br>`constraints`<br>`assumptions`<br>`risks`<br>`evidence_gaps` |
| 3 | `decision_plan`    | Decision plan    | `ai_tool`  | `sme_hiring_scorecard_kit_decision` | yes    | `summary`<br>`decision`<br>`actions`<br>`metrics`<br>`risks`<br>`evidence_gaps`        |
| 4 | `execution_brief`  | Execution brief  | `shortcut` | `sme_hiring_scorecard_kit`          | yes    | `summary`<br>`decision`<br>`actions`<br>`risks`<br>`evidence_gaps`                     |
