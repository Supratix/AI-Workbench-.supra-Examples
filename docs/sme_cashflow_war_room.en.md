...
- **Source package:** [`../sme_cashflow_war_room.supra`](../sme_cashflow_war_room.supra)
- **Workbench title:** SME Cashflow War Room Desk
- **Package key:** `sme_cashflow_war_room`
- **Module:** `sme_cashflow_war_room`
- **Vendor:** SupraTix
- **Schema version:** `1`
...
Prioritize cashflow risks and convert them into an owner-ready recovery action board.

## Starter Intake

### SME Cashflow War Room starter

- **Request:** Paste the source context for SME Cashflow War Room.
...
| 2 | `signal_map`       | Signal map       | `ai_tool`  | `sme_cashflow_war_room_signals`  | `business_context`                                    | `manual_review` | yes    | `summary`<br>`signals`<br>`constraints`<br>`assumptions`<br>`risks`<br>`evidence_gaps` |
| 3 | `decision_plan`    | Decision plan    | `ai_tool`  | `sme_cashflow_war_room_decision` | `business_context`<br>`signal_map`                    | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`metrics`<br>`risks`<br>`evidence_gaps`        |
| 4 | `execution_brief`  | Execution brief  | `shortcut` | `sme_cashflow_war_room`          | `business_context`<br>`signal_map`<br>`decision_plan` | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`risks`<br>`evidence_gaps`                     |
