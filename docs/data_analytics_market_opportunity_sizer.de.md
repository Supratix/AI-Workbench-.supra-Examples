...
Schätzt Markt- oder Chancenpotenziale mit transparenten Annahmen, Szenarien, Sensitivitätschecks, Evidenzlücken und Validierungsprioritäten.

## Starter-Eingabe

### Data Analytics Market And Opportunity Sizer Starter

- **Anfrage:** Fügen Sie den Quellkontext für Data Analytics Market And Opportunity Sizer ein.
...
| 2 | `signal_map`       | Signal map       | `ai_tool`  | `data_analytics_market_opportunity_sizer_signals`  | ja      | `summary`<br>`signals`<br>`constraints`<br>`assumptions`<br>`risks`<br>`evidence_gaps` |
| 3 | `decision_plan`    | Decision plan    | `ai_tool`  | `data_analytics_market_opportunity_sizer_decision` | ja      | `summary`<br>`decision`<br>`actions`<br>`metrics`<br>`risks`<br>`evidence_gaps`        |
| 4 | `execution_brief`  | Execution brief  | `shortcut` | `data_analytics_market_opportunity_sizer`          | ja      | `summary`<br>`decision`<br>`actions`<br>`risks`<br>`evidence_gaps`                     |
