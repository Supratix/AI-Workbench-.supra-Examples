...
- **Source package:** [`../sme_review_reputation_responder.supra`](../sme_review_reputation_responder.supra)
- **Workbench title:** SME Review Reputation Responder Desk
- **Package key:** `sme_review_reputation_responder`
- **Module:** `sme_review_reputation_responder`
- **Vendor:** SupraTix
- **Schema version:** `1`
...
Draft review responses and reputation recovery actions with evidence-aware tone.

## Starter Intake

### SME Review Reputation Responder starter

- **Request:** Paste the source context for SME Review Reputation Responder.
...
| 2 | `signal_map`       | Signal map       | `ai_tool`  | `sme_review_reputation_responder_signals`  | `business_context`                                    | `manual_review` | yes    | `summary`<br>`signals`<br>`constraints`<br>`assumptions`<br>`risks`<br>`evidence_gaps` |
| 3 | `decision_plan`    | Decision plan    | `ai_tool`  | `sme_review_reputation_responder_decision` | `business_context`<br>`signal_map`                    | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`metrics`<br>`risks`<br>`evidence_gaps`        |
| 4 | `execution_brief`  | Execution brief  | `shortcut` | `sme_review_reputation_responder`          | `business_context`<br>`signal_map`<br>`decision_plan` | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`risks`<br>`evidence_gaps`                     |
