...
Draft review responses and reputation recovery actions with evidence-aware tone, escalation guidance, service signals, and follow-up checks.
...
| 2 | `signal_map`       | Signal map       | `ai_tool`  | `sme_review_reputation_responder_signals`  | yes    | `summary`<br>`signals`<br>`constraints`<br>`assumptions`<br>`risks`<br>`evidence_gaps` |
| 3 | `decision_plan`    | Decision plan    | `ai_tool`  | `sme_review_reputation_responder_decision` | yes    | `summary`<br>`decision`<br>`actions`<br>`metrics`<br>`risks`<br>`evidence_gaps`        |
| 4 | `execution_brief`  | Execution brief  | `shortcut` | `sme_review_reputation_responder`          | yes    | `summary`<br>`decision`<br>`actions`<br>`risks`<br>`evidence_gaps`                     |
