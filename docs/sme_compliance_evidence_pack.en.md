...
- **Module:** `sme_compliance_evidence_pack`
- **Vendor:** SupraTix
- **Schema version:** `1`
...
Organize compliance facts into an evidence pack with gaps, owners, and reviewer notes.
...
| 2 | `signal_map`       | Signal map       | `ai_tool`  | `sme_compliance_evidence_pack_signals`  | `business_context`                                    | `manual_review` | yes    | `summary`<br>`signals`<br>`constraints`<br>`assumptions`<br>`risks`<br>`evidence_gaps` |
| 3 | `decision_plan`    | Decision plan    | `ai_tool`  | `sme_compliance_evidence_pack_decision` | `business_context`<br>`signal_map`                    | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`metrics`<br>`risks`<br>`evidence_gaps`        |
| 4 | `execution_brief`  | Execution brief  | `shortcut` | `sme_compliance_evidence_pack`          | `business_context`<br>`signal_map`<br>`decision_plan` | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`risks`<br>`evidence_gaps`                     |
