...
- **Quellpaket:** [`../sme_upsell_signal_miner.supra`](../sme_upsell_signal_miner.supra)
- **Workbench-Titel:** SME Upsell Signal Miner Desk
- **Paket-Key:** `sme_upsell_signal_miner`
- **Modul:** `sme_upsell_signal_miner`
- **Anbieter:** SupraTix
- **Schema-Version:** `1`
...
Find upsell signals and convert them into account-specific next actions.
...
| 2 | `signal_map`       | Signal map       | `ai_tool`  | `sme_upsell_signal_miner_signals`  | `business_context`                                    | `manual_review` | yes    | `summary`<br>`signals`<br>`constraints`<br>`assumptions`<br>`risks`<br>`evidence_gaps` |
| 3 | `decision_plan`    | Decision plan    | `ai_tool`  | `sme_upsell_signal_miner_decision` | `business_context`<br>`signal_map`                    | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`metrics`<br>`risks`<br>`evidence_gaps`        |
| 4 | `execution_brief`  | Execution brief  | `shortcut` | `sme_upsell_signal_miner`          | `business_context`<br>`signal_map`<br>`decision_plan` | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`risks`<br>`evidence_gaps`                     |
