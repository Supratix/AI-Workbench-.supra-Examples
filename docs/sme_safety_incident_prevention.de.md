...
Convert safety incident notes into prevention actions with root-cause hypotheses, responsible owners, verification checks, and review triggers.
...
| 2 | `signal_map`       | Signal map       | `ai_tool`  | `sme_safety_incident_prevention_signals`  | yes    | `summary`<br>`signals`<br>`constraints`<br>`assumptions`<br>`risks`<br>`evidence_gaps` |
| 3 | `decision_plan`    | Decision plan    | `ai_tool`  | `sme_safety_incident_prevention_decision` | yes    | `summary`<br>`decision`<br>`actions`<br>`metrics`<br>`risks`<br>`evidence_gaps`        |
| 4 | `execution_brief`  | Execution brief  | `shortcut` | `sme_safety_incident_prevention`          | yes    | `summary`<br>`decision`<br>`actions`<br>`risks`<br>`evidence_gaps`                     |
