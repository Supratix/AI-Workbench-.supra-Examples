...
- **Quellpaket:** [`../data_analytics_experiment_launch_analyzer.supra`](../data_analytics_experiment_launch_analyzer.supra)
- **Workbench-Titel:** Data Analytics Experiment And Launch Analyzer Desk
- **Paket-Key:** `data_analytics_experiment_launch_analyzer`
- **Modul:** `data_analytics_experiment_launch_analyzer`
- **Anbieter:** SupraTix
- **Schema-Version:** `1`
...
Turn experiment and launch notes into a decision-ready analytics review.
...
| 2 | `signal_map`       | Signal map       | `ai_tool`  | `data_analytics_experiment_launch_analyzer_signals`  | `business_context`                                    | `manual_review` | yes    | `summary`<br>`signals`<br>`constraints`<br>`assumptions`<br>`risks`<br>`evidence_gaps` |
| 3 | `decision_plan`    | Decision plan    | `ai_tool`  | `data_analytics_experiment_launch_analyzer_decision` | `business_context`<br>`signal_map`                    | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`metrics`<br>`risks`<br>`evidence_gaps`        |
| 4 | `execution_brief`  | Execution brief  | `shortcut` | `data_analytics_experiment_launch_analyzer`          | `business_context`<br>`signal_map`<br>`decision_plan` | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`risks`<br>`evidence_gaps`                     |
