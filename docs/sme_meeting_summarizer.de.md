...
- **Quellpaket:** [`../sme_meeting_summarizer.supra`](../sme_meeting_summarizer.supra)
- **Workbench-Titel:** SME Meeting Summarizer Desk
- **Paket-Key:** `sme_meeting_summarizer`
- **Modul:** `sme_meeting_summarizer`
- **Anbieter:** SupraTix
- **Schema-Version:** `1`
...
Summarize meeting notes into decisions, actions, risks, and evidence gaps.
...
| 2 | `signal_map`       | Signal map       | `ai_tool`  | `sme_meeting_summarizer_signals`  | `business_context`                                    | `manual_review` | yes    | `summary`<br>`signals`<br>`constraints`<br>`assumptions`<br>`risks`<br>`evidence_gaps` |
| 3 | `decision_plan`    | Decision plan    | `ai_tool`  | `sme_meeting_summarizer_decision` | `business_context`<br>`signal_map`                    | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`metrics`<br>`risks`<br>`evidence_gaps`        |
| 4 | `execution_brief`  | Execution brief  | `shortcut` | `sme_meeting_summarizer`          | `business_context`<br>`signal_map`<br>`decision_plan` | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`risks`<br>`evidence_gaps`                     |
