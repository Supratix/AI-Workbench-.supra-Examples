...
- **Module:** `sme_local_seo_content_engine`
- **Vendor:** SupraTix
- **Schema version:** `1`
...
Generate local SEO content briefs from business context, service areas, and proof points.
...
| 2 | `signal_map`       | Signal map       | `ai_tool`  | `sme_local_seo_content_engine_signals`  | `business_context`                                    | `manual_review` | yes    | `summary`<br>`signals`<br>`constraints`<br>`assumptions`<br>`risks`<br>`evidence_gaps` |
| 3 | `decision_plan`    | Decision plan    | `ai_tool`  | `sme_local_seo_content_engine_decision` | `business_context`<br>`signal_map`                    | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`metrics`<br>`risks`<br>`evidence_gaps`        |
| 4 | `execution_brief`  | Execution brief  | `shortcut` | `sme_local_seo_content_engine`          | `business_context`<br>`signal_map`<br>`decision_plan` | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`risks`<br>`evidence_gaps`                     |
