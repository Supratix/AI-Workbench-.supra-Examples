...
- **Quellpaket:** [`../sme_lead_qualifier.supra`](../sme_lead_qualifier.supra)
- **Workbench-Titel:** SME Lead Qualifier Desk
- **Paket-Key:** `sme_lead_qualifier`
- **Modul:** `sme_lead_qualifier`
- **Anbieter:** SupraTix
- **Schema-Version:** `1`
...
Qualify leads with fit, urgency, risk, and next-best-action recommendations.
...
| 2 | `signal_map`       | Signal map       | `ai_tool`  | `sme_lead_qualifier_signals`  | `business_context`                                    | `manual_review` | yes    | `summary`<br>`signals`<br>`constraints`<br>`assumptions`<br>`risks`<br>`evidence_gaps` |
| 3 | `decision_plan`    | Decision plan    | `ai_tool`  | `sme_lead_qualifier_decision` | `business_context`<br>`signal_map`                    | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`metrics`<br>`risks`<br>`evidence_gaps`        |
| 4 | `execution_brief`  | Execution brief  | `shortcut` | `sme_lead_qualifier`          | `business_context`<br>`signal_map`<br>`decision_plan` | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`risks`<br>`evidence_gaps`                     |
