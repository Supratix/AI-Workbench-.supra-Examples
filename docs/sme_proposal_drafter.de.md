...
- **Quellpaket:** [`../sme_proposal_drafter.supra`](../sme_proposal_drafter.supra)
- **Workbench-Titel:** SME Proposal Drafter Desk
- **Paket-Key:** `sme_proposal_drafter`
- **Modul:** `sme_proposal_drafter`
- **Anbieter:** SupraTix
- **Schema-Version:** `1`
...
Draft a proposal brief with scope, assumptions, risks, and next-step language.
...
| 2 | `signal_map`       | Signal map       | `ai_tool`  | `sme_proposal_drafter_signals`  | `business_context`                                    | `manual_review` | yes    | `summary`<br>`signals`<br>`constraints`<br>`assumptions`<br>`risks`<br>`evidence_gaps` |
| 3 | `decision_plan`    | Decision plan    | `ai_tool`  | `sme_proposal_drafter_decision` | `business_context`<br>`signal_map`                    | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`metrics`<br>`risks`<br>`evidence_gaps`        |
| 4 | `execution_brief`  | Execution brief  | `shortcut` | `sme_proposal_drafter`          | `business_context`<br>`signal_map`<br>`decision_plan` | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`risks`<br>`evidence_gaps`                     |
