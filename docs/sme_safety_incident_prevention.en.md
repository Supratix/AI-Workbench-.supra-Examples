...
- **Source package:** [`../sme_safety_incident_prevention.supra`](../sme_safety_incident_prevention.supra)
- **Workbench title:** SME Safety Incident Prevention Loop Desk
- **Package key:** `sme_safety_incident_prevention`
- **Module:** `sme_safety_incident_prevention`
- **Vendor:** SupraTix
- **Schema version:** `1`
...
Convert safety incident notes into prevention actions, owner checks, and review triggers.

## Starter Intake

### SME Safety Incident Prevention Loop starter

- **Request:** Paste the source context for SME Safety Incident Prevention Loop.
...
| 2 | `signal_map`       | Signal map       | `ai_tool`  | `sme_safety_incident_prevention_signals`  | `business_context`                                    | `manual_review` | yes    | `summary`<br>`signals`<br>`constraints`<br>`assumptions`<br>`risks`<br>`evidence_gaps` |
| 3 | `decision_plan`    | Decision plan    | `ai_tool`  | `sme_safety_incident_prevention_decision` | `business_context`<br>`signal_map`                    | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`metrics`<br>`risks`<br>`evidence_gaps`        |
| 4 | `execution_brief`  | Execution brief  | `shortcut` | `sme_safety_incident_prevention`          | `business_context`<br>`signal_map`<br>`decision_plan` | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`risks`<br>`evidence_gaps`                     |
