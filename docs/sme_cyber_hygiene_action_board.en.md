...
- **Source package:** [`../sme_cyber_hygiene_action_board.supra`](../sme_cyber_hygiene_action_board.supra)
- **Workbench title:** SME Cyber Hygiene Action Board Desk
- **Package key:** `sme_cyber_hygiene_action_board`
- **Module:** `sme_cyber_hygiene_action_board`
- **Vendor:** SupraTix
- **Schema version:** `1`
...
Convert cyber hygiene observations into a prioritized remediation board for SME teams.

## Starter Intake

### SME Cyber Hygiene Action Board starter

- **Request:** Paste the source context for SME Cyber Hygiene Action Board.
...
| 2 | `signal_map`       | Signal map       | `ai_tool`  | `sme_cyber_hygiene_action_board_signals`  | `business_context`                                    | `manual_review` | yes    | `summary`<br>`signals`<br>`constraints`<br>`assumptions`<br>`risks`<br>`evidence_gaps` |
| 3 | `decision_plan`    | Decision plan    | `ai_tool`  | `sme_cyber_hygiene_action_board_decision` | `business_context`<br>`signal_map`                    | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`metrics`<br>`risks`<br>`evidence_gaps`        |
| 4 | `execution_brief`  | Execution brief  | `shortcut` | `sme_cyber_hygiene_action_board`          | `business_context`<br>`signal_map`<br>`decision_plan` | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`risks`<br>`evidence_gaps`                     |
