...
- **Quellpaket:** [`../data_analytics_kpi_framework_designer.supra`](../data_analytics_kpi_framework_designer.supra)
- **Workbench-Titel:** Data Analytics KPI Framework Designer Desk
- **Paket-Key:** `data_analytics_kpi_framework_designer`
- **Modul:** `data_analytics_kpi_framework_designer`
- **Anbieter:** SupraTix
- **Schema-Version:** `1`
...
Design a practical KPI framework with metric definitions, owners, and review cadence.
...
| 2 | `signal_map`       | Signal map       | `ai_tool`  | `data_analytics_kpi_framework_designer_signals`  | `business_context`                                    | `manual_review` | yes    | `summary`<br>`signals`<br>`constraints`<br>`assumptions`<br>`risks`<br>`evidence_gaps` |
| 3 | `decision_plan`    | Decision plan    | `ai_tool`  | `data_analytics_kpi_framework_designer_decision` | `business_context`<br>`signal_map`                    | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`metrics`<br>`risks`<br>`evidence_gaps`        |
| 4 | `execution_brief`  | Execution brief  | `shortcut` | `data_analytics_kpi_framework_designer`          | `business_context`<br>`signal_map`<br>`decision_plan` | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`risks`<br>`evidence_gaps`                     |
