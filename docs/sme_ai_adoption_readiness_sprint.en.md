...
- **Source package:** [`../sme_ai_adoption_readiness_sprint.supra`](../sme_ai_adoption_readiness_sprint.supra)
- **Workbench title:** SME AI Adoption Readiness Sprint Desk
- **Package key:** `sme_ai_adoption_readiness_sprint`
- **Module:** `sme_ai_adoption_readiness_sprint`
- **Vendor:** SupraTix
- **Schema version:** `1`
...
Assess SME AI adoption readiness and create a concrete first-sprint action plan.

## Starter Intake

### SME AI Adoption Readiness Sprint starter

- **Request:** Paste the source context for SME AI Adoption Readiness Sprint.
...
| 2 | `signal_map`       | Signal map       | `ai_tool`  | `sme_ai_adoption_readiness_sprint_signals`  | `business_context`                                    | `manual_review` | yes    | `summary`<br>`signals`<br>`constraints`<br>`assumptions`<br>`risks`<br>`evidence_gaps` |
| 3 | `decision_plan`    | Decision plan    | `ai_tool`  | `sme_ai_adoption_readiness_sprint_decision` | `business_context`<br>`signal_map`                    | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`metrics`<br>`risks`<br>`evidence_gaps`        |
| 4 | `execution_brief`  | Execution brief  | `shortcut` | `sme_ai_adoption_readiness_sprint`          | `business_context`<br>`signal_map`<br>`decision_plan` | `manual_review` | yes    | `summary`<br>`decision`<br>`actions`<br>`risks`<br>`evidence_gaps`                     |
