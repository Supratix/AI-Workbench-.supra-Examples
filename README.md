...
A portable, ready-to-use collection of `.supra` examples for SupraTix AI Workbench. It can live in any checkout and can be copied into an AI Workbench examples directory when needed.
...
| Lieferschein → Lagerbestand (Internal Products) | Map delivery-note lines to internal products, flag ambiguous matches, and produce a reviewable stock update proposal for inventory teams.                   | 3 columns / 1 workflow  | [EN](docs/lieferschein_inventory.en.md) · [DE](docs/lieferschein_inventory.de.md)                                       |
